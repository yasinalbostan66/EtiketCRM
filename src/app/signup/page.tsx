      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 sm:p-12 lg:p-24 bg-white">
        <div className="w-full max-w-md space-y-8 relative">
          ...
          <div className="text-center lg:text-left">
            ...
            <p className="text-slate-500 mt-2 font-medium">14 gün ücretsiz deneme sürümünü başlatın.</p>
          </div>
          ...
          <form onSubmit={handleSignup} className="space-y-5 mt-10">
            <div className="space-y-4">
              ...
              <div className="relative">
                <label className="text-xs font-bold text-slate-500 uppercase tracking-wider mb-2 block">Şifre</label>
                <div className="relative">
